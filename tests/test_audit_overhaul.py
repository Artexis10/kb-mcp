...
def test_audit_frontmatter_compliance_flags_tenant_without_q_project(vault: Path) -> None:
    """`tenant:` set on a non-Q research-note should be flagged."""
    _seed(
        vault / "Knowledge Base" / "Notes" / "Research" / "Endstate" / "wrong-tenant.md",
        "---\ntype: research-note\nproject: endstate\ntenant: tu\n"
        "status: active\ncreated: 2026-05-15\nupdated: 2026-05-15\n"
        "tags: []\n---\n\n# Wrong tenant\n\nBody.\n",
    )
