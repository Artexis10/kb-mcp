...
The lint-finds-but-doesn't-fix model leaves Hugo (or an LLM) doing the same
...
- `frontmatter_compliance: tenant set without project: q` — might be a
  legitimate Q-tenant edge case Hugo intends.
