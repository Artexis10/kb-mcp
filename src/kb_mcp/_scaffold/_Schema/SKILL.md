...
| **preserve** | Capture a **text** factual artifact for an incident scope. Binaries (PDF / image / any file) go out-of-band via `/upload` (`mint_upload_token` on web), not this tool | `Evidence/<scope>/` |
